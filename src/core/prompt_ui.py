...
function ragDraft(){return {
  ...
  retrieval_history_mode:$('ragHistoryMode').value,retrieval_history_turns:Number($('ragHistoryTurns').value),retrieval_min_similarity:optionalNumber('ragMinSimilarity'),max_chunks_per_document:optionalNumber('ragMaxChunksPerDoc'),system_prompt:$('ragSystemPrompt').value,timezone:$('ragTimezone').value.trim(),
