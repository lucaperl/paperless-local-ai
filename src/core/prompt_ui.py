...
from history_common import cached_history_state, history_excluded_tag_names
...
def tagging_state(*, force=False):
    ...
    if force:
        history = refresh_history(shutdown_after=False)
    else:
