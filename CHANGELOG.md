...
- persist and validate a compact local TF-IDF history cache, use equivalent sparse cosine scoring instead of a persistent nearest-neighbor estimator, and rebuild on source/runtime mismatch;
